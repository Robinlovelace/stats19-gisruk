...
time. However, the results in suggest that London (controlled by the
...
risk-ratios for each year represented as coloured bars.

![An approximate geographical layout of England and Wales police force
areas following the layout algorithm published in Meulemans et al.
(2017)](semispatial_layout.png)

![Risk ratios of KSI rates by force area averaged over 2013-2017 (left
and middle), with year-on-year trend in risk ratios and raw KSIs
(right)](risk_ratio_maps.png)
...
increase in serious and fatal casualties concerning, especially given
