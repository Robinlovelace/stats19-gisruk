...
Building on the recently released **stats19** R package, the paper contains code that downloads, processes and reformats over half a million incidents (78,448 car-pedestrian crashes) from 2013 to 2017.
The dataset reveals variability in crash characteristics depending on social, environmental and regulatory factors, and variable performance in terms of 'risk ratios' over space and time.
...
The recent narional increase in serious and fatal casualties is concerning, especially given the government's commitment to contribute to the European Union's target of halving road traffic deaths by 2050.^[
